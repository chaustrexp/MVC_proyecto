...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $instructor->setInstNombres($_POST['inst_nombres']);
    $instructor->setInstApellidos($_POST['inst_apellidos']);
    $instructor->setInstCorreo($_POST['inst_correo']);
    $instructor->setInstTelefono($_POST['inst_telefono']);
...
<header class="bg-primary text-white pt-4 pb-6 px-5 sticky top-0 z-30 shadow-md">
    <div class="flex items-center gap-3 mb-4">
        ...
        <h1 class="text-xl font-bold tracking-tight">Editar Instructor</h1>
    </div>
</header>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input 
                        type="text" 
                        name="inst_nombres" 
                        value="<?= $instructor->getInstNombres() ?>"
                        required
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        name="inst_apellidos" 
                        value="<?= $instructor->getInstApellidos() ?>"
                        required
                        class="w-full bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg py-2.5 px-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                    />
                </div>
                ...
                <div>
                    ...
                    <input 
                        type="email" 
                        name="inst_correo" 
                        value="<?= $instructor->getInstCorreo() ?>"
                        required
                        class="w-full bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg py-2.5 px-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                    />
                </div>
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        name="inst_telefono" 
                        value="<?= $instructor->getInstTelefono() ?>"
                        required
                        class="w-full bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg py-2.5 px-4 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                    />
                </div>
