...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $titulo = new TituloPrograma(null, $_POST['titpro_nombre']);
        ...
        <div class="px-6 py-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Nuevo Título</h1>
                        <p class="text-sm text-purple-600 font-semibold">Crear Título de Programa</p>
                    </div>
                </div>
                <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <span class="material-icons-outlined text-white text-3xl">add_circle</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="glass rounded-2xl overflow-hidden shadow-xl">
                <div class="bg-gradient-to-br from-purple-500 to-indigo-600 p-6 text-white">
                    ...
                    <p class="text-purple-100 text-sm">Complete los datos del nuevo título de programa</p>
                </div>
                ...
                <div class="p-8">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="titpro_nombre" required
                            placeholder="Ej: Técnico en Sistemas, Tecnólogo en Desarrollo de Software..."
                            class="w-full px-5 py-4 bg-white border-2 border-purple-100 rounded-xl focus:outline-none focus:border-purple-400 transition-colors text-lg">
                        <p class="text-xs text-gray-500 mt-2 flex items-center space-x-1">
                            <span class="material-icons-outlined text-sm">info</span>
                            <span>Ingrese el nombre completo del título que otorga el programa</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="glass rounded-2xl p-6 shadow-lg">
                <div class="flex items-start space-x-3">
                    <div class="w-10 h-10 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
                        <span class="material-icons-outlined text-blue-600">lightbulb</span>
                    </div>
                    <div>
                        <h3 class="font-bold text-gray-800 mb-1">Ejemplos de Títulos</h3>
                        <ul class="text-sm text-gray-600 space-y-1">
                            <li>• Técnico en Sistemas</li>
                            <li>• Tecnólogo en Análisis y Desarrollo de Software</li>
                            <li>• Técnico en Mantenimiento de Equipos de Cómputo</li>
                            <li>• Tecnólogo en Gestión de Redes de Datos</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="flex space-x-4">
                <button type="submit" 
                    class="flex-1 bg-gradient-to-r from-purple-500 to-indigo-600 text-white py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all hover:scale-105 flex items-center justify-center space-x-2">
