...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    $sede->setSedeNombre($_POST['sede_nombre']);
    Sede::update($sede);
...
<header class="px-4 pb-4 bg-primary dark:bg-slate-900 sticky top-12 z-40 rounded-b-[2rem] shadow-lg">
    <div class="flex items-center justify-between mb-4 pt-2">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="text-2xl font-bold tracking-tight text-white">Editar Sede</h1>
        </div>
    </div>
</header>
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800">
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-lg font-bold text-primary-dark">#<?= $sede->getSedeId() ?></p>
                </div>
