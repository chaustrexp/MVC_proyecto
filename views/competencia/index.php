...
$titulo = 'Competencia - Historias de Usuario';
$titulo_pagina = 'Gestión de Competencia';
$action = 'competencia';
...
<div class="card">
    <div class="card-header">
        <h2>Historias de Usuario - Competencia</h2>
        <a href="index.php?action=competencia_crear" class="btn btn-success">➕ Nueva Historia</a>
    </div>
                ...
                <?php if (mysqli_num_rows($resultado) > 0): ?>
                    <?php while ($historia = mysqli_fetch_assoc($resultado)): ?>
                        <tr>
                            ...
                            <td>
                                <div class="acciones">
                                    <a href="index.php?action=competencia_ver&id=<?php echo $historia['id']; ?>" class="btn btn-primary btn-sm">Ver</a>
                                    <a href="index.php?action=competencia_editar&id=<?php echo $historia['id']; ?>" class="btn btn-secondary btn-sm">Editar</a>
                                </div>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="8" style="text-align: center; padding: 30px;">
                            ...
                            <a href="index.php?action=competencia_crear">Crear la primera historia</a>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
