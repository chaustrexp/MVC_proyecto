...
$titulo = 'Editar Historia - Ambiente';
$titulo_pagina = 'Editar Historia de Usuario';
$action = 'ambiente_editar';
...
<div class="card">
    ...
    <form method="POST" action="">
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <a href="index.php?action=ambiente_ver&id=<?php echo $id; ?>" class="btn btn-primary">👁️ Ver Detalle</a>
            <a href="index.php?action=ambiente" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
